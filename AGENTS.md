...
5. Caches new thumbnails in R2 (avoids TikTok CDN hotlink issues).
6. Appends new videos to `pins`, updates `seenReelIds`, writes back to `sf-ai-tiktok-videos.json`.
